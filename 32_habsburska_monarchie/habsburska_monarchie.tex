...
\begin{itemize}
    ...
    \item[1572] volnost vyznání: \textit{Česká konfese} (\textit{Confessio Bohemica}) $\rightarrow$ lutheráni, ultrakvisté a další jsou spokojení, protože mohou vyznávat svoji víru
\end{itemize}
