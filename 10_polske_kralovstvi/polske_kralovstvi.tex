...
\begin{itemize}
    ...
    \item[(1000)] v Hnězdně zřízeno arcibiskupství při hrobu sv. Vojtěcha, arcibiskup Radim (nevlastní bratr Vojtěcha)
    \item[(1025)] na konci života královský titul -> první polský král
    \item[$-$] soustava hradů
\end{itemize}
...
\begin{itemize}
    \vspace{-0.5em}
    \setlength\itemsep{0.15em}
    \item[1226] pozval do země řád německých rytířů, aby šířili křesťanství -> ovládli Prusko
